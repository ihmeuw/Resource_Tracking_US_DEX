################################################
#' @description Write config file for CRT STGPR for PHARMA
################################################
library(data.table)
rm(list = ls())

## *************************************************
notes <- "Extending to 1990 and matching lambda to EC models"
## *************************************************
...
me_name <- "crt_interpolating" ## required
modelable_entity_name <- "CRT interpolating"
